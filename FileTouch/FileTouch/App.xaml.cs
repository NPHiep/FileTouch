...
namespace FileTouch
{
    ...
    {
        public static SimpleObservableTask myFloat;
        public static bool isUpLoad = true;
        /// <summary>
        ...
        private void Application_ContractActivated(object sender, IActivatedEventArgs e)
        {
            if(isUpLoad)
            {
                ...
                var fileSaveContinuationArgs = e as FileSavePickerContinuationEventArgs;
                if (fileSaveContinuationArgs != null)
                {
                    this.FileSavePickerContinuationArgs = fileSaveContinuationArgs;
                }
            }
        }
        /// <summary>
        ...
        public App()
        {
            ...
            myFloat = new SimpleObservableTask(0);
